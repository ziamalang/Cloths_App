export const designCollections = [
  ...
  },
  {
    ...
    details: 'Engaging editorial visuals tailored for a modern storefront and high-impact campaigns.',
  },
  {
    id: 3,
    title: 'Runway Glow',
...
export function fetchDesignCollections() {
  return Promise.resolve(designCollections)
}

export function fetchDashboardData() {
  return Promise.resolve({ stats: dashboardStats, updates: dashboardUpdates })
}
